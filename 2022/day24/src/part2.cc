...
int main(int argc, char ** argv)
{
    ...
    int r1 = solve(info, bliz, info.start, info.end);
    int r2 = solve(info, bliz, info.end, info.start);
    int r3 = solve(info, bliz, info.start, info.end);

    cout << "r1: " << r1 << endl;
    cout << "r2: " << r2 << endl;
    cout << "r3: " << r3 << endl;

    cout << "ans: " << r1 + r2 + r3 - 1 << endl;
